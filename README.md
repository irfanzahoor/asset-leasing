...
Worked example at PKR 45,000 a month: ten days starting in January bill
PKR 14,516.13, the same ten days starting in February PKR 16,071.43, and any
full calendar month PKR 45,000. Calculations live in
...
```bash
bench get-app git@github.com:irfanzahoor/asset-leasing-erpnext.git
