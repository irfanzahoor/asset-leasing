...
def create_price_list(currency=None):
	...
	PKR is the fallback because the confirmed client operates in India; a site
	...
	if not currency:
		...
		currency = (company and frappe.db.get_value("Company", company, "default_currency")) or "PKR"
	frappe.get_doc({
		"doctype": "Price List",
